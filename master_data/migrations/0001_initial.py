# Generated by Django 5.0 on 2025-05-09 11:27
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Buyer',
            fields=[
                ('contactinfo_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='master_data.contactinfo')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contact_info', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='emails', to='master_data.contactinfo')),
            ],
        ),
        migrations.CreateModel(
            name='PersonPhone',
            fields=[
                ...
                ('contact_info', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='phones', to='master_data.contactinfo')),
            ],
        ),
        migrations.CreateModel(
            name='ProductImage',
            fields=[
                ...
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='images', to='master_data.product')),
            ],
        ),
        migrations.AddField(
            model_name='product',
            name='customer_name',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='master_data.customer'),
        ),
    ]
